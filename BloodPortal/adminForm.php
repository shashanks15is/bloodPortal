...
<script type="text/javascript">
      ...
      filter_organizer_query("all")
  });

  function filter_organizer_query(str) {
   if(str){
                 
                $.ajax({
                    url:"organizersList.php",
                    type:"post",
                    data:{
                        "str":str
                    },
                    success:function(data){
                        ...
                        var table_content=""
                        $('#organizer_list').find( 'tr:not(:first)' ).remove();
                        $.each(obj,function(index,value){
                            table_content+="<tr>";
                            table_content+="<td contenteditable=\"true\"><center>"+value.name+"</center></td>";
                            table_content+="<td contenteditable=\"true\"><center>"+value.venue+"</center></td>";
                            table_content+="<td contenteditable=\"true\"><center>"+value.date+"</center></td>";
                            table_content+="<td contenteditable=\"true\"><center>"+value.email+"</center></td>";
                            table_content+="<td contenteditable=\"true\"><center>"+value.phone+"</center></td>";
                            table_content+="<td contenteditable=\"true\"><center>"+value.message+"</center></td>";  
                            table_content+="<td><span class=\"btn btn-info\" style=\"color:#fff\"  onclick=\"register('"+value.id+"',this.id)\">Delete</span></td>";

                        });
                        $("#organizer_list").append(table_content);
   ...
   function register(id) {
                         var hold=id;
                         $.ajax({
                    url:"adminForm_operation.php",
                    type:"post",
                    data:{
                        "str":id
                    },
                    success:function(data){
                        filter_organizer_query();
...
?>    
    ...
    <header class="top-area" id="home">
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse bs-example-js-navbar-scrollspy">
                            ...
                            <ul id="nav" class="nav navbar-nav cl-effect-11">
                                <li><a href="#catagories" class="active">Organizers Enquiry</a></li>
                                <li><a href="adminForm2.php">Enquiries</a></li>
                                <li><a href="adminForm3.php">donorList</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
        ...
        <!--ENQUIRY AREA-->
    <section class="faqs-area section-padding black-bg" id="catagories" style="margin-top: 100px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="area-title text-center">
                        <h2>Organizers Enquiry</h2>
                    </div>
                </div>
            </div>
            <div class="row">
              ...
              <div class="pricing-table-content">
                <div class="row">
                  <div class="col-md-12 col-sm-6 col-xs-12">
                    <div id="here1" class="single-table-price "><center><strong style="text-align: right;"></strong></center><br><br>
                        <table width="629" class="table table-bordered " id="organizer_list">

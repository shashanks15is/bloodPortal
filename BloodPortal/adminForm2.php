...
<head>
    ...
    <script type="text/javascript">
      ...
      filter_user_enquiry("all")
  });

  function filter_user_enquiry(str) {
   if(str){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        var table_content=""
                        $('#hospital_list1').find( 'tr:not(:first)' ).remove();
                        $.each(obj,function(index,value){
                            ...
                            table_content+="<td><span class=\"btn btn-info\" style=\"color:#fff\"  onclick=\"register1('"+value.id+"',this.id)\">Delete</span></td>";                        
                        });
                        $("#hospital_list1").append(table_content);
              ...
              <div class="pricing-table-content">
                <div class="row">
                  <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="single-table-price "><center><strong style="text-align: right;"></strong></center><br><br>
                        <table width="629" class="table table-bordered " id="hospital_list1">
